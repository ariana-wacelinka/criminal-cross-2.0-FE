...
export class ClientPage {
  ...
  protected readonly bookingsPage = toSignal(
    this.bookingsApi.getAll({ userId: this.userId(), page: 0, limit: 20, sort: 'createdAt:desc' }),
    {
      initialValue: null,
    },
  );
  ...
  protected readonly bookingsCount = computed(() => this.bookingsPage()?.total ?? 0);
